...
| 08 | [`feature-08-polish-readability-and-screens`](changes/feature-08-polish-readability-and-screens/proposal.md) | Readability, colors, HUD, primary screens, control hints, and text fit after builds, sounds, and level content are in place. | [design](changes/feature-08-polish-readability-and-screens/design.md), [tasks](changes/feature-08-polish-readability-and-screens/tasks.md), [specs](changes/feature-08-polish-readability-and-screens/specs/) |
| 09 | [`feature-09-polish-event-feedback-and-qol`](changes/feature-09-polish-event-feedback-and-qol/proposal.md) | Visible feedback for important gameplay events plus bounded quality-of-life polish from play observations. | [design](changes/feature-09-polish-event-feedback-and-qol/design.md), [tasks](changes/feature-09-polish-event-feedback-and-qol/tasks.md), [specs](changes/feature-09-polish-event-feedback-and-qol/specs/) |
| 10 | [`feature-10-add-online-leaderboard-client`](changes/feature-10-add-online-leaderboard-client/proposal.md) | Optional HTTP leaderboard client integration with local-first fallback; server-side score persistence remains separate. | [design](changes/feature-10-add-online-leaderboard-client/design.md), [tasks](changes/feature-10-add-online-leaderboard-client/tasks.md), [specs](changes/feature-10-add-online-leaderboard-client/specs/) |
