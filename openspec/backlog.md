...
| 05 | [`feature-05-add-distribution-builds`](changes/feature-05-add-distribution-builds/proposal.md) | Shareable Windows `.exe` and Linux artifacts, with GitHub Actions support and Linux installer options documented. | [design](changes/feature-05-add-distribution-builds/design.md), [tasks](changes/feature-05-add-distribution-builds/tasks.md), [specs](changes/feature-05-add-distribution-builds/specs/) |
| 06 | [`feature-06-add-basic-sounds`](changes/feature-06-add-basic-sounds/proposal.md) | Baseline sound effects for launch, collisions, brick breaks, power-up pickup, and level completion, with a path for later asset upgrades. | [design](changes/feature-06-add-basic-sounds/design.md), [tasks](changes/feature-06-add-basic-sounds/tasks.md), [specs](changes/feature-06-add-basic-sounds/specs/) |
| 07 | [`feature-07-add-level-pack-and-difficulty`](changes/feature-07-add-level-pack-and-difficulty/proposal.md) | Expand the level set to 3-5 levels and define a clearer difficulty curve. | [design](changes/feature-07-add-level-pack-and-difficulty/design.md), [tasks](changes/feature-07-add-level-pack-and-difficulty/tasks.md), [specs](changes/feature-07-add-level-pack-and-difficulty/specs/) |
