...
- [ ] 1.1 Improve color palette and contrast for bricks, paddle, ball, and HUD.
- [ ] 1.2 Add clearer menu, pause, level-clear, and game-over presentation.
...
- [ ] 3.1 Add lightweight font or UI assets only if they improve readability.
- [ ] 3.2 Keep event feedback, QoL tuning, sound, and level-content follow-ups out of this slice unless they are bug fixes.
